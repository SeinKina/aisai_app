...
class SectionBox extends StatelessWidget {
  ...
  SectionBox({required this.title, required this.users});
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                UserModel user = users[index]; // UserModelのインスタンスを取得
                return Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              CircleAvatar(
                                ...
                                backgroundImage: AssetImage('assets/image/user_placeholder.png'), // プレースホルダー画像
                              ),
                              SizedBox(height: 8.0),
                              Text(
                                user.name,
